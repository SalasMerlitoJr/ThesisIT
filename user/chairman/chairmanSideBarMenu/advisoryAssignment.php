...
<form method="POST" action="advisersTeams.php">   
    <button type="submit" class="edit_btn" style="float: right">List of Advisers</button> 
</form>
<!-------------------------->  

<!-------------------------->
<form method="POST" action="viewTeamswithAdviser.php">   
    <button type="submit" class="edit_btn">List of Groups with Advisers</button> 
</form>
<!-------------------------->   
