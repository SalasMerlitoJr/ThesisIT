...
<form method="POST" action="advisersTeams.php">   
    <button type="submit" class="edit_btn" style="float: right">View Advisers</button> 
</form>
<!-------------------------->  
                ...
                <table id="zctb" class="display table table-striped table-bordered table-hover" cellspacing="0" width="100%">
                  <thead>
                    <tr>
                      ...
                      <th>Group<strong> Adviser</strong></th>
                      <th>Action</th> 
                    </tr>
                  </thead>
...
?>
      <tr>
        ...
        <td><mark><?php echo htmlentities($row4->group_name);?></mark></td>
        <td><mark><?php echo htmlentities($row4->name);?></mark></td>
