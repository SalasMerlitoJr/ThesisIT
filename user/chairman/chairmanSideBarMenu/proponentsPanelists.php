                ...
                <table id="zctb" class="display table table-striped table-bordered table-hover" cellspacing="0" width="100%">
                  <thead>
                    <tr>
                      ...
                      <th><strong>Panelist Name</strong></th>
                      <th>Action</th> 
                    </tr>
                  </thead>
...
<?php
    ...
    //$sql4 = "SELECT user_id,name,group_ad from users_tbl inner join thesis_panels_tbl on panelist_id = user_id where type = 'faculty' ";
...
<td>
<a href="proponentsPanelistsView.php?viewproponents=<?php echo htmlentities($row4->user_id); ?>" >View <strong>Groups</strong></a>
</td>
                    </tr>
                  <?php } ?>
