        ...
        <div class="row">
          <div class="col-md-12">
            ...
            if(isset($_POST['edit_password'])){
                ...
                $current_password=md5($_SESSION["userpassword"]);
                ...
                while  ($row = mysqli_fetch_object($records)) {
                  if(($row->userpassword) != ($password)){
                   ...
                   if(($row->userpassword) == ($password)){
                      ...
                      //echo "<script>alert('Password already existed')</script>";
                      $sql="UPDATE users_tbl SET userpassword='$current_password' where email = '$my_email' ";
