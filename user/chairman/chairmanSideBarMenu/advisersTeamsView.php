...
<?php 
  ...
  include '../../../includes/connect.php';
    ...
    while  ($row4 = mysqli_fetch_object($records4)) { ?>   
      ...
      <center><h3><strong>The adviser of the following groups below</strong></h3></center>
...
<!-------------------------->
<form method="POST" action="advisersTeams.php">   
...
<?php
    ...
    $selected_id = $_GET['viewgroups'];
    $sql4 = "SELECT group_id,group_name,adviser from users_tbl INNER JOIN group_tbl on user_id = adviser where adviser = '$selected_id'  ";
