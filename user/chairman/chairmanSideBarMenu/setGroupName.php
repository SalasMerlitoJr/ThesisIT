...
<!-------------------------->
<form method="POST" action="groupAssignment.php">   
...
<?php 
  ...
  if(isset($_GET['delete'])){
    $group = $_GET['delete'];
    $sql = "DELETE from group_tbl where group_id = '$group' ";
    $stmt = $conn->prepare($sql);
    $stmt->execute();

   $sql1 = "UPDATE users_tbl set user_status = 0 where user_status = '$group' ";
