...
<!-------------------------->
<form method="POST" action="Sec_thesisMins.php">   
            ...
            <div class="row">                    
              <div class="col-md-12">
                <div class="panel panel-default">
                  <div class="panel-heading">Thesis Minutes</div>
...
<div class="form-group">
  ...
  <div class="col-sm-10">
    <input type="" class="form-control" rows="5" name="venue">
  </div>
</div>

<div class="form-group">
  <label class="col-sm-2 control-label">General Comments<span style="color:red">*</span></label>
  <div class="col-sm-10">
