    ...
    <nav class="cd-side-nav js-cd-side-nav">
      ...
      <ul class="cd-side__list js-cd-side__list">
        ...
        <li class="cd-side__item cd-side__item--has-children cd-side__item--comments js-cd-item--has-children">
          ...
          <ul class="cd-side__sub-list">
            <!--<center><li class="cd-side__sub-item"><a href="adminSideBarMenu/manageStudents.php">Student Management</a></li></center>-->
            <center><li style="background-color:#4169E1" class="cd-side__sub-item"><a href="Pan_prefSched.php">Preferred Schedule</a></li></center>
      ...
      <div class="container-fluid">
        ...
        <div class="row">
          <div class="col-md-12">
            ...
            <center><h2 class="page-title">Preferred Schedule Page</h2></center>
...
<div class="form-group">
  ...
  <div class="col-sm-10">
  <textarea class="form-control" rows="5" name="Message" placeholder="Message the chairman with your preferred schedule"></textarea>
  </div>
</div>
