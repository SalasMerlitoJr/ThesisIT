      ...
      <div class="container-fluid">
        ...
        <div class="row">
          <div class="col-md-12">
            ...
            <center><h3 class="page-title">Project Concept</h3></center>
            ...
            <center>
              <form style="margin-top: 5em" name="myform" method="POST">
                

                <label style="margin-right: 5em"><h3><strong>Rubric</strong></h3></label>
                <label><h3><strong>Scores</strong></h3></label><br>

                <label><h4>Research Topic</h4></label><br>
                <input type="number" name="rt" min="5" max="20" interval="5"  required=""><br><br>
                ...
                <label><h4>Relevant Literature and Related Existing Application</h4></label><br>
                <input type="number" name="rrl" min="5" max="20" required=""><br><br>

                <label><h4>Issues and Gap</h4></label><br>
                <input type="number" name="ig" min="5" max="20" required=""><br><br>

                <label><h4>Possible Solutions/Enhancement and Impact</h4></label><br>
                <input type="number" name="psei" min="5" max="20" required=""><br><br>

                <label><h4>Overall Concept Presentation</h4></label><br>
                <input type="number" name="ocp" min="5" max="20" required=""><br><br><br><br>
