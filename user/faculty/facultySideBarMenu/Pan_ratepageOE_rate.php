        ...
        <div class="row">
          <div class="col-md-12">
            ...
            <?php 
              ...
              $sql0 = "SELECT a.thesis_id,group_id,b.thesis_id,phase_id,thesis_phase_status from thesis_tbl a INNER JOIN thesis_phase_tbl b on a.thesis_id = b.thesis_id where group_id = '$selected_id' limit 1"; //duplicated
...
<form method="POST" action="Pan_ratepagePP.php">
    ...
    <!--<center> <a href="Pan_ratepagePP.php?panelrate=<?php // echo htmlentities( $row5->group_id); ?>"></a></center>-->
</form> 
